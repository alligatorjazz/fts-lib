...
export default function NewIssue({ issue }) {
    ...
    return (_jsx(Tailwind, { config: tailwindConfig, children: _jsxs(Html, { children: [_jsxs(Head, { children: [_jsx("title", { children: issue?.data.title ?? "Issue Title" }), _jsx(Font, { fontFamily: "Cousine", fallbackFontFamily: "Verdana", webFont: {
                                ...
                                format: "woff2"
                            }, fontWeight: 400, fontStyle: "normal" })] }), _jsx(Preview, { children: issue?.data.description ?? faker.lorem.text() }), _jsxs(Body, { className: "text-textColor bg-bgColor p-4", children: [_jsx(Link, { href: issueLink, className: "leading-tight text-textColor", target: "_blank", children: _jsxs(Section, { children: [_jsxs(Heading, { as: "h1", className: "text-3xl text-textColor", children: [">: FTS | ", `${dayjs(issue?.data.publishDate ?? Date.now()).format("MM.YYYY")}`] }), _jsx(Heading, { as: "h2", className: "text-lg text-textColor", children: issue?.data.title ?? faker.lorem.sentence({ min: 5, max: 10 }).toLowerCase() }), _jsx(Heading, { as: "h2", className: "text-sm", children: issue?.data.description ?? faker.lorem.sentence() }), _jsx(Text, { className: "text-accentColor font-bold text-xl", children: ">: Read on Main Site ↗" })] }) }), _jsx(Hr, {}), _jsx(Container, { className: "w-full", children: _jsx(Img, { src: issue?.data.poster ?? faker.image.urlPlaceholder({ width: 1280, height: 720 }), alt: issue?.data.description, width: 854, height: 480, className: "object-contain w-full max-h-72" }) }), _jsx(Markdown, { markdownCustomStyles: {
