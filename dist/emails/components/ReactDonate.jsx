...
export function ReactDonate() {
    return (<Link aria-label="A link to the From The Superhighway Patreon page." href="https://patreon.com/fromthesuperhighway" className="">
		<Section className="bg-fgColor uppercase w-64 px-4 py-2 text-textColor">
			<Column>
				<Img src={patreonImg} width="16" height="16" alt="Patreon" className="inline-block"/>
			</Column>
			<Column>
